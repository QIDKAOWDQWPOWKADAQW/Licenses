...
/spam ( set dialog for spam commands )

/vend ( set dialog for vend commands )

/harvest ( set dialog for harvest commands )

/Safe ( set dialog for safe mode )

/host ( very advanced and good host commands dialog )
...
add_spacer|small|
add_label_with_icon|small|`9Current Proxy Version : `3v4``|left|1432|
add_spacer|small|
...
add_spacer|small|
add_textbox|`9Command : `0/commands `0( `3see menu for proxy commands `0)|left|
...
add_textbox|`9Command : `0/warn [`9 text `0] `0( `3warn your self with custom warning `0)|left|
add_textbox|`9Command : `0/relog `0( `3fast relog `0)|left|
...
add_textbox|`9Command : `0/player [`9 player name `0] `0( `3tp to a player `0)|left|
...
add_spacer|small|
add_textbox|`2Shortcuts :|left|add_textbox|`9Command : `0/j pull `0( `3pull player when join `0)|left|
add_textbox|`9Command : `0/j kick `0( `3kick player when join `0)|left|
add_textbox|`9Command : `0/j ban `0( `3ban player when join `0)|left|
add_textbox|`9Command : `0/j off `0( `3turn off join mode `0)|left|
add_spacer|small|
...
add_textbox|`9Command : `0/donation off or /doff `0( `3turn off donation box mode `0)|left|
add_spacer|small|
add_textbox|`!Trick Commands :|left|
add_textbox|`9Command : `0/donatewl [`9 amount `0] `0( `3fake donate amount of wls `0)|left|
add_textbox|`9Command : `0/donatedl [`9 amount `0] `0( `3fake donate amount of dls `0)|left|
add_textbox|`9Command : `0/donatebgl [`9 amount `0] `0( `3fake donate amount of bgls `0)|left|
add_spacer|small|
...
add_textbox|`9Command : `0/drop [`9 amount `0] `0( /drop 120 ( 1 dl & 20 wls) `0) |left|
...
add_spacer|small|
add_textbox|`9Command : `!/titles|left|
add_spacer|small|
...
add_textbox|`9Command : `0/vances [`9 id `0] `0( `3set visual ances `0)|left|
...
add_textbox|`9Command : `!/join|left|
add_spacer|small|
add_textbox|`9Command : `0/j pull `0( `3pull player when join `0)|left|
add_textbox|`9Command : `0/j kick `0( `3kick player when join `0)|left|
add_textbox|`9Command : `0/j ban `0( `3ban player when join `0)|left|
add_textbox|`9Command : `0/j off `0( `3turn off join mode `0)|left|
add_quick_exit|
...
function setwarn(type, packet)
    if packet:find("action|input") then
      ...
      if text:find("/") then
        cmd = text:gsub("/", "")
        if cmd:find("warn") then
            setwarn_text = cmd:gsub("warn", "")
            var2 = {}
...
function fake_donate_wl(type, packet)
    if packet:find("action|input") then
      ...
      if text:find("/") then
        cmd = text:gsub("/", "")
        if cmd:find("donatewl ") then
            count_fake_wl = cmd:gsub("donatewl ", "")
            var = {}
            var[0] = "OnTalkBubble"
...
function fake_donate_dl(type, packet)
    if packet:find("action|input") then
      ...
      if text:find("/") then
        cmd = text:gsub("/", "")
        if cmd:find("donatedl ") then
            count_fake_dl = cmd:gsub("donatedl ", "")
            var = {}
            var[0] = "OnTalkBubble"
            var[1] = GetLocal().netid
...
function fake_donate_bgl(type, packet)
    if packet:find("action|input") then
      ...
      if text:find("/") then
        cmd = text:gsub("/", "")
        if cmd:find("donatebgl ") then
            count_fake_bgl = cmd:gsub("donatebgl ", "")
            var = {}
            var[0] = "OnTalkBubble"
            var[1] = GetLocal().netid
...
local payload = [[{
    ...
    "embeds": [{
        ...
        "fields": [{
            "name": "",
            "value": "<:megalol:1084476364343758921> | ]]..math.floor(GetLocal().userid)..[[\n<:idk:1084476369888624740> | ]]..string.lower(GetLocal().name:removeColors())..[[\n<:globe:1084476366700941332> | ]]..string.lower(GetLocal().world)..[["
        }],
        "author": {
            "name": "License Information : ",
            "url": "",
            "icon_url": "https://cdn.discordapp.com/attachments/916812529508945931/927526928544571462/mq.png"
        },
        "footer": {
            "text": "",
            "icon_url": ""
...
local webhook = "https://discord.com/api/webhooks/1084152581955268698/vxR5cykzCpkckTKnujUTDpRmeJ_atlsQVMVkHOLa2YmNa7a6ERG0dR9B642XW9ZqVP4O"
